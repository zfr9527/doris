...
suite("test_ddl_table_api_auth","p0,auth") {
    ...
    String dbName = 'test_ddl_table_api_auth_db'
    String tableName = 'test_ddl_table_api_auth_tb'
    String tableNameNew = 'test_ddl_table_api_auth_tb_new'
    String cteLikeDstDb = 'test_ddl_table_api_cte_like_dst_db'
    String cteLikeDstTb = 'test_ddl_table_api_cte_like_dst_tb'
    String cteSelectDstDb = 'test_ddl_table_api_cte_select_dst_db'
    String cteSelectDstTb = 'test_ddl_table_api_cte_select_dst_tb'
