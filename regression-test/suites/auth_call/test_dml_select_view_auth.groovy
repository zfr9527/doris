...
suite("test_dml_select_view_auth","p0,auth") {

    String user = 'test_dml_select_view_auth_user'
    String pwd = 'C123_567p'
    String dbName = 'test_dml_select_view_auth_db'
    String tableName = 'test_dml_select_view_auth_tb'
    String viewName = 'test_dml_select_view_auth_view'
