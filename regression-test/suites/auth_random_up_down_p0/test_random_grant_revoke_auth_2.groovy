...
suite("test_random_upgrade_downgrade_compatibility_auth_2","p0,auth,restart_fe") {
    ...
    connect(user1, "${pwd}", context.config.jdbcUrl) {
        ...
        if (version_3 || version_2_1) {
            ...
            assertTrue(grants_res[0][5] == "hive2_test_random_up_down_auth_ctl.default_cluster:test_auth_up_down_db: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ; hive3_test_random_up_down_auth_ctl.default_cluster:test_auth_up_down_db: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ; internal.default_cluster:information_schema: Select_priv ; internal.default_cluster:mysql: Select_priv ; internal.default_cluster:regression_test: Select_priv ; internal.default_cluster:test_auth_up_down_db: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ")
            assertTrue(grants_res[0][6] == "hive2_test_random_up_down_auth_ctl.default_cluster:test_auth_up_down_db.test_auth_up_down_table1: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ; hive3_test_random_up_down_auth_ctl.default_cluster:test_auth_up_down_db.test_auth_up_down_table1: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ; internal.default_cluster:test_auth_up_down_db.test_auth_up_down_table1: Select_priv Load_priv Alter_priv Create_priv Drop_priv Show_view_priv ")
        }
    }
