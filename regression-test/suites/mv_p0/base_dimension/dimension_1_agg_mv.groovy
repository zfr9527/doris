...
suite("partition_mv_rewrite_dimension_1_agg_mv", "partition_mv_rewrite_dimension_1_agg_mv") {
    ...
    sql """CREATE TABLE `lineitem_agg` (
      ...
      `l_quantity` DECIMAL(15, 2) REPLACE,
      `l_extendedprice` DECIMAL(15, 2) REPLACE,
      `l_discount` DECIMAL(15, 2) REPLACE,
      `l_tax` DECIMAL(15, 2) REPLACE,
    ...
    (1, null, '2023-10-17', 'o', 109.2, 'c','d',2, 'mm'),
