 ...
 */
suite("partition_mv_rewrite_dimension_2_6_mv", "partition_mv_rewrite_dimension_2_6_mv") {
...
//    sql """DROP MATERIALIZED VIEW IF EXISTS ${mv_name_4};"""
    ...
    waitingMVTaskFinished("lineitem_2_6", mv_name_5)
    ...
    waitingMVTaskFinished("lineitem_2_6", mv_name_6)
...
//    sql """DROP MATERIALIZED VIEW IF EXISTS ${mv_name_8};"""
    ...
    waitingMVTaskFinished("orders_2_6", mv_name_9)
