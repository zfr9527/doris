 ...
 */
suite("partition_mv_rewrite_dimension_2_agg_mv", "partition_mv_rewrite_dimension_2_agg_mv") {
    ...
    waitingMVTaskFinished("orders_2_agg", mv_name_1)
    ...
    waitingMVTaskFinished("orders_2_agg", mv_name_10)
    ...
    waitingMVTaskFinished("orders_2_agg", mv_name_15)
    ...
    waitingMVTaskFinished("lineitem_2_agg", mv_name_6)
