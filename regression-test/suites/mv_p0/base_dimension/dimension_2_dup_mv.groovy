...
suite("partition_mv_rewrite_dimension_2_dup_mv", "partition_mv_rewrite_dimension") {
    ...
    def create_mv_lineitem = { mv_name, mv_sql ->
        sql """DROP MATERIALIZED VIEW IF EXISTS ${mv_name} on lineitem_2_3;"""
    ...
    def create_mv_orders = { mv_name, mv_sql ->
        sql """DROP MATERIALIZED VIEW IF EXISTS ${mv_name} on orders_2_3;"""
        sql """DROP TABLE IF EXISTS ${mv_name}"""
        sql"""
        CREATE MATERIALIZED VIEW ${mv_name} 
        AS  
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_2)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_3)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_10)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_11)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_16)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_12)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_13)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_14)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_15)
    ...
    waitingMVTaskFinished("lineitem_2_3", mv_name_6)
    ...
    waitingMVTaskFinished("orders_2_3", mv_name_9)
