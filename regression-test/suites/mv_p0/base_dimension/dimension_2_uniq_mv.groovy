 ...
 */
suite("partition_mv_rewrite_dimension_2_uniq_mv", "partition_mv_rewrite_dimension_2_uniq_mv") {
    ...
    sql_stmt_5 = """select t.l_shipdate, o_orderdate, t.l_partkey 
        from (select l_shipdate, l_partkey, l_orderkey from lineitem_2_uniq group by l_shipdate, l_partkey, l_orderkey) t 
