suite("agg_negative_mv_test") {
    ...
    sql """create materialized view ${mv_name} as select col4, col1, col2, col3, col15, sum(col7) from ${tb_name} where col1 = "2023-08-16 22:27:00" group by col4, col3, col1, col2, col15 order by col1, col2, col3, col15"""
