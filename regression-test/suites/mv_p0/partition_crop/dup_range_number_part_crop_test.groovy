...
suite("dup_range_number_part_crop", "mv_part_crop") {
    String db = context.config.getDbNameByFile(context.file)
    String orders_tb = "dup_orders_number_date_crop_part"
    ...
    def mv_name = "dup_rang_number_crop_part_mtmv"
    def mv_sql = """
