...
suite("mtmv_list_date_datetrunc_date_part_up", "zfr_mtmv_test") {
    ...
    String mv_prefix = "list_datetrunc_date_up"
    ...
    partition by list (`l_shipdate`) (
        partition p1 values in ("2023-10-29 00:00:00"),
        partition p2 values in ("2023-10-29 01:00:00"),
        partition p3 values in ("2023-10-29 02:00:00"),
        partition p4 values in ("2023-10-29 03:00:00"),
        partition p5 values in ("2023-10-29 04:00:00")
    )
