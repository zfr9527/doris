...
//
//    def sql_stmt_4 = """select l_shipdate, o_orderdate, l_partkey, l_suppkey from `${catalog_name}`.`${db}`.lineitem_1 """
//    explain {
//        sql("${sql_stmt_4}")
//        contains "${mv_name_4}(${mv_name_4})"
//    }
//    sql_stmt_4 = """select o_orderdate from `${catalog_name}`.`${db}`.orders_1 """
//    explain {
//        sql("${sql_stmt_4}")
//        contains "${mv_name_4}(${mv_name_4})"
//    }
