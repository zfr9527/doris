 ...
 */
suite("partition_mv_rewrite_dimension_right_semi_join_hive", "dimension") {
    ...
    String ctl = "mv_rewrite_dimension_right_semi_join"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_2_right_anti_join"
            def lineitem_tb = "lineitem_2_right_anti_join"
