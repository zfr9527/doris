...
suite("hive_join_agg_replenish_negative") {
    ...
    String ctl = "mv_rewrite_hive_join_agg_negative"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_hive_join_agg_negative"
            def lineitem_tb = "lineitem_hive_join_agg_negative"
            def partsupp_tb = "partsupp_hive_join_agg_negative"
            ...
            for (int i = 0; i < sql_list.size(); i++) {
                ...
                def mv_name = ctl + "_mv_negative_" + (i + 1)
