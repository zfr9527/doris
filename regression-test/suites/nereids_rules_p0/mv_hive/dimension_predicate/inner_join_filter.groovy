...
suite("inner_join_filter_hive") {
    ...
    String ctl = "mv_rewrite_inner_filter_hive"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_inner_join"
            def lineitem_tb = "lineitem_inner_join"
            ...
            for (int i = 0; i < mv_list_1.size(); i++) {
                logger.info("i:" + i)
                def mv_name = """mv_name_inner_join_${i}"""
