...
suite("left_join_filter_hive") {
    ...
    String ctl = "mv_rewrite_left_filter_hive"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_left_join"
            def lineitem_tb = "lineitem_left_join"
            ...
            for (int i = 0; i < mv_list_1.size(); i++) {
                logger.info("i:" + i)
                def mv_name = """mv_name_left_join_${i}"""
                if (i < 5) {
