 ...
 */
suite("right_join_filter_hive", "dimension_predicate") {
    ...
    String ctl = "mv_rewrite_right_filter_hive"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_right_join"
            def lineitem_tb = "lineitem_right_join"
            ...
            for (int i = 0; i < mv_list_1.size(); i++) {
                logger.info("i:" + i)
                def mv_name = """mv_name_right_join_${i}"""
                if (i > 4) {
