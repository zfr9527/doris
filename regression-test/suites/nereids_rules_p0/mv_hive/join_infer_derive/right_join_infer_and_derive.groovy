 ...
 */
suite("right_join_infer_and_derive_hive", "join_infer_derive") {
    ...
    String ctl = "right_infer_derive_hive"
    ...
    for (String hivePrefix : ["hive2", "hive3"]) {
        try {
            ...
            def order_tb = "orders_right"
            def lineitem_tb = "lineitem_right"
