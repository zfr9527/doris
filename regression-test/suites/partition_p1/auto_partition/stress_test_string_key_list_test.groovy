...
suite("stress_test_string_key_list") {
    ...
    def tb_name2 = "stream_load_list_test_table_string_key"

    sql """create database if not exists ${database_name};"""
    sql """use ${database_name};"""
    sql """drop table if exists ${tb_name2};"""
    sql new File("""${context.file.parent}/ddl/stream_load_range_test_table_diff_data.sql""").text

    data_delete("stringkey")
    doris_dbgen_create_data(database_name, tb_name2, "stringkey")
    doris_dbgen_load_data(database_name, tb_name2, "stringkey")
    ...
    assertTrue(26 == partition_res_range.size)
