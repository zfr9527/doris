suite("variables_up_down_test5_3fe") {
...
//    sql """create view v_test_decimal_mul_overflow1 as select f1,f2,f1*f2 multi from test_decimal_mul_overflow1;"""
    ...
    order_qt_scale_is_11 "select multi from v_test_decimal_mul_overflow1;"
    // expect column c1 scale is 8: 999999999999998246906000000000.76833464
    order_qt_scale_is_8 "select multi+1 c1 from v_test_decimal_mul_overflow1;"
...
//    """
    order_qt_plus "select * from v_plus;"
...
//        set enable_decimal256=false;
//    """
    order_qt_subtract "select * from v_subtract;"
...
//        set enable_decimal256=false;
//    """
    order_qt_divide "select * from v_divide;"
...
//        set enable_decimal256=false;
//    """
    order_qt_mod "select * from v_mod;"
...
//    where t1.c1=t2.c1;"""
//    sql "set enable_decimal256=false;"
    order_qt_view_inner_expression "select * from test_lower_project;"
...
//    sql "set enable_decimal256=true;"
    // 查询嵌套视图，预期是256精度的
    order_qt_nest_view "select * from test_nested_view;"
...
//    create view test_nested_view_expr as select col1+1 from test_lower_project;"""
    // 查询嵌套视图，预期是128精度的
    sql "set enable_decimal256=true;"
    order_qt_nest_view_expr_256 "select * from test_nested_view_expr;"
    sql "set enable_decimal256=false;"
    order_qt_nest_view_expr_128 "select * from test_nested_view_expr;"
...
//    create view v_test_avg as select f1, avg(f2) col_avg from test_decimal_mul_overflow1 group by f1;"""
    sql "set enable_decimal256=true;"
    order_qt_sum1 "select col_sum from v_test_sum;"
    order_qt_avg1 "select col_avg from v_test_avg;"
    sql "set enable_decimal256=false;"
    order_qt_sum2 "select col_sum from v_test_sum;"
    order_qt_avg2 "select col_avg from v_test_avg;"
...
//    create view v_test_avg_expr as select f1, avg(f1*f2) col_avg from test_decimal_mul_overflow1 group by f1;"""
    sql "set enable_decimal256=true;"
    order_qt_agg_expr_sum1 "select col_sum from v_test_sum_expr;"
    order_qt_agg_expr_avg1 "select col_avg from v_test_avg_expr;"
    sql "set enable_decimal256=false;"
    order_qt_agg_expr_sum2 "select col_sum from v_test_sum_expr;"
    order_qt_agg_expr_avg2 "select col_avg from v_test_avg_expr;"
...
//        set enable_decimal256=false;
//    """
    order_qt_agg_distinct "select col_sum from v_test_agg_distinct;"
...
//        set enable_decimal256=false;
//    """
    order_qt_agg_funcs "select * from v_test_agg_func;"
...
//        set enable_decimal256=false;
//    """
    order_qt_two_phase_agg "select * from v_test_agg_two_phase;"
...
//        set enable_decimal256=false;
//    """
    order_qt_agg_without_gby "select * from v_test_agg_without_gby;"
...
//    set enable_decimal256=false;"""
    order_qt_distinct_agg_rewrite "select * from v_distinct_agg_rewrite;"
...
//        set enable_decimal256=false;
//    """
    order_qt_window "select * from test_window_sum;"
...
//        set enable_decimal256=false;
//    """
    order_qt_window_expr "select * from test_window_sum_expr;"
...
//        set enable_decimal256=false;
//    """
    order_qt_if "select col_if from v_test_if;"
...
//        set enable_decimal256=false;
//    """
    order_qt_casewhen "select col_cw from v_test_casewhen;"
...
//        set enable_decimal256=false;
//    """
    order_qt_if_condition_func "select * from v_test_if_condition;"
...
//    set enable_decimal256=false;"""
    order_qt_array_funcs "select * from v_test_array_func;"
...
//    set enable_decimal256=false;"""
    order_qt_array_product "select * from v_test_array_product;"
...
//        set enable_decimal256=false;
//    """
    order_qt_compare_expr "select * from v_test_compare;"
...
//        set enable_decimal256=false;
//    """
    order_qt_int "select * from v_test_in;"
...
//        set enable_decimal256=false;
//    """
    order_qt_union "select * from v_test_union;"
