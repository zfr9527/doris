...
//"""
    ...
    order_qt_sum0 """ select sum_merge(col_sum) from t01 group by id order by id;
             """
    order_qt_avg0 """ select avg_merge(col_avg) from t01 group by id order by id;
             """
...
//    """
    ...
    """
    order_qt_avg_256_0 """ select avg_merge(col_avg) from t01 group by id order by id;
             """
    sql "set enable_decimal256=true;"
    test {
        sql """select sum_merge(col_sum) from t01 group by id order by id;"""
